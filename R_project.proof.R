...
HD <- read.table("/Users/MarkHenley/Documents/GitHub/Rproject/Hurricane_Data.csv", 
                 header = TRUE,
                 sep = ",")

# Read in Sea surface temp table csv files
SST <- read.table("/Users/MarkHenley/Documents/GitHub/Rproject/Sea_surface_temp.csv", 
                  header = TRUE,
                  sep = ",")
...
# Scatter plot of sea surface anomaly through the years
ggplot(Analysis.ready, aes(Year, Group.anomaly), col= "red", main= "Sea Surface Temperature Anomaly", xlab = "Year", ylab = "Sea Surface Temperature Anomaly °F") +
  geom_line()

# Scatter plot of sea surface anomaly through the years with line at y=0
Temp.anomaly <- ggplot(data=Analysis.ready, aes(x=Year, y=Group.anomaly)) + geom_point()
# Add horizontal line at y = 0
Temp.anomaly + geom_hline(yintercept=0)

# Scatter plot of hurricane frequency through the years with line at y=0
Temp.anomaly2 <- ggplot(data=Analysis.ready, aes(x=Year, y=Freq)) + geom_point()
# Add horizontal line at y = 0
Temp.anomaly2 + geom_hline(yintercept=0)
